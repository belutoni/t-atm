...
public:
    ...
    bank_account_t(
        ...
        const std::vector<std::shared_ptr<transaction_t>> &transactions) : username(std::move(username)),
                                                                            pin(std::move(pin)),
    ...
    bank_account_t(bank_account_t &&other) noexcept : identifier(std::move(other.identifier)),
